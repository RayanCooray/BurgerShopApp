...
export default function HomePage() {
  ...
  const handleLogin = () => {
    ...
    navigation.navigate("Login"); // Replace with actual navigation logic
  };

  useEffect(() => {
    Animated.timing(lineWidth, {
      toValue: 300, // Final width of the line
      duration: 1000, // Duration of the animation
      useNativeDriver: false, // Since width is not supported by native driver
    }).start();
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.facebookButton}>
        <Image
          source={require("../../assets/facebooksignup.png")}
      ...
      <View style={styles.bottomView}>
        ...
        <Text style={styles.alreadyText}>If you already have an account</Text>
        <Animated.View
